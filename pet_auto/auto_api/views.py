...
class AutoSearchViewSet(viewsets.GenericViewSet):
    ...
    def search():
        ...
        r = requests.get('https://developers.ria.com/auto/search?api_key=&marka_id[0]=6&model_id[0]=39&s_yers[0]=1992&po_yers[0]=2005&engineVolumeFrom=2.8&drive_type[0]=1&bodystyle[0]=3')
        data = r.json()
    ...
    def create(post_id):
        r = requests.get(f'https://developers.ria.com/auto/info?api_key=&auto_id={post_id}')
        data = r.json()
